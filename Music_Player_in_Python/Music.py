...
# Displaying the Buttons with Icon
play_img = PhotoImage(file="C:\\Users\\dell\\Documents\\0 Ram document\\3 codeclause Internship\\Music Player in"
                           " Python\\play.png")
pause_img = PhotoImage(file="C:\\Users\\dell\\Documents\\0 Ram document\\3 codeclause Internship\\Music Player in"
                            " Python\\pause.png")
stop_img = PhotoImage(file="C:\\Users\\dell\\Documents\\0 Ram document\\3 codeclause Internship\\Music Player in"
                           " Python\\stop.png")


# All the frames
song_frame = LabelFrame(root, text='Current Song', bg='LightBlue', width=1000, height=80)
song_frame.place(x=0, y=0)

button_frame = LabelFrame(root, text='Control Buttons', bg='Turquoise', width=1000, height=160)
button_frame.place(y=80)

listbox_frame = LabelFrame(root, text='Playlist', bg='RoyalBlue')
listbox_frame.place(x=0, y=240, height=200, width=1000)
...
pause_btn = Button(button_frame, text='Pause', image=pause_img, bg='Aqua', font=("Georgia", 13), width=7,
                   command=lambda: pause_song(song_status))
pause_btn.place(x=15, y=10)

stop_btn = Button(button_frame, text='Stop', image=stop_img, bg='Aqua', font=("Georgia", 13), width=7,
                  command=lambda: stop_song(song_status))
stop_btn.place(x=105, y=10)

play_btn = Button(button_frame, text='Play', image=play_img, bg='Aqua', font=("Georgia", 13), width=7,
